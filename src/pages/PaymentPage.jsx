        ...
        <div className="bg-white rounded-xl p-4 mb-4 shadow-sm">
          ...
          {selectedMethod === 'upi' && (
            <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-xl text-center">
              ...
              <a
                href={upiLink}
                className="mt-3 w-full block bg-#F4DDB2 text-#54433C py-3 rounded-full font-bold text-sm flex items-center justify-center gap-2 active:scale-95 transition-all"
                onClick={(e) => {
